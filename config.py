...
TRAINED_MODEL = "vehicle_diag_smach/res/trained_model_milestone_demo.h5"
...
DUMMY_ISOLATION_OSCILLOGRAM_NEG = "vehicle_diag_smach/res/dummy_isolation_oscillogram/dummy_isolation_NEG.csv"
